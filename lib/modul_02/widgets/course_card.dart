...
class CourseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      clipBehavior: Clip.antiAlias, // Biar efek ripple InkWell rapi di sudut card
      child: InkWell(
        onTap: () {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Dosen Pengampu', style: theme.textTheme.bodySmall),
                            Text(course.lecturer, style: const TextStyle(fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Icon(Icons.meeting_room_outlined, size: 18, color: Colors.orange),
                            const SizedBox(width: 6),
                            Text(course.room),
                          ],
                        ),
