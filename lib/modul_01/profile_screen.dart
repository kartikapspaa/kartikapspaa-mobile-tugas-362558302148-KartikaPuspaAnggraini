...
class PoliwangiProfileApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF0284C7)), // Biru Poliwangi 0xFF0284C7 || poliwangi 0xFFFF1493 = 0xFFFF1493 
        useMaterial3: true,
      ),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Nama mahasiswa
              const Text(
                'Kartika Puspa Anggraini', // Ganti dengan nama asli Anda
                style: TextStyle(
                  fontSize: 22,
              ...
              Container(
                ...
                child: const Text(
                  'NIM: 362558302148', // Ganti dengan NIM asli Anda
                  style: TextStyle(
                    fontSize: 13,
                  ...
                  child: Column(
                    children: [
                      ...
                      _InfoRow(
                        ...
                        label: 'Program Studi',
                        value: 'Sarjana Terapan Teknologi Rekayasa Perangkat Lunak (TRPL)',
                      ),
                      Divider(height: 24, color: Color(0xFFF1F5F9)),
                      _InfoRow(
